/****************************************************************lo que habia en bootstrap-table.js*/
/**
...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button style="float: right !important;" class="btn btn-default waves-light" type="button" name="refresh" title="%s">',
                this.options.formatRefresh()),
                sprintf('<i class="material-icons">loop</i>', this.options.iconsPrefix, this.options.icons.refresh),
                '</button>');
        }
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div style="float: left !important;" class="pull-' + this.options.searchAlign + ' search">',
                    sprintf('<input id="buscar1" class="form-control" type="text" placeholder="%s" size="50">',
