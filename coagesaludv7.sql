...
--
-- Host: localhost
-- Generation Time: Mar 19, 2017 at 06:51 AM
...
--
-- Table structure for table `tab_asociado`
--
...
CREATE TABLE `tab_asociado` (
  ...
  `asociado_departamento` int(100) NOT NULL,
...
--
-- Table structure for table `tab_beneficiario`
--
...
--
-- Table structure for table `tab_capital`
--
...
--
-- Table structure for table `tab_credito`
--
...
--
-- Table structure for table `tab_credito_movimiento`
--
...
--
-- Table structure for table `tab_cuenta`
--
...
--
-- Table structure for table `tab_cuenta_autorizados`
--
...
--
-- Table structure for table `tab_cuenta_movimiento`
--
...
--
-- Table structure for table `tab_institucion_salud`
--
...
--
-- Table structure for table `tab_solicitud_credito`
--
...
--
-- Table structure for table `tab_tipo_credito`
--
...
--
-- Dumping data for table `tab_tipo_credito`
--
...
--
-- Table structure for table `tab_tipo_cuenta`
--
...
--
-- Dumping data for table `tab_tipo_cuenta`
--
...
--
-- Indexes for table `tab_asociado`
--
...
--
-- Indexes for table `tab_configuracion`
--
...
--
-- Indexes for table `tab_credito_movimiento`
--
...
--
-- Indexes for table `tab_institucion_salud`
--
ALTER TABLE `tab_institucion_salud`
  ADD PRIMARY KEY (`institucionsalud_id`);

--
-- Indexes for table `tab_solicitud_credito`
--
...
--
-- Constraints for table `tab_asociado`
--
ALTER TABLE `tab_asociado`
...
--
-- Constraints for table `tab_beneficiario`
--
ALTER TABLE `tab_beneficiario`
...
--
-- Constraints for table `tab_credito`
--
ALTER TABLE `tab_credito`
...
--
-- Constraints for table `tab_credito_movimiento`
--
ALTER TABLE `tab_credito_movimiento`
...
--
-- Constraints for table `tab_cuenta`
--
ALTER TABLE `tab_cuenta`
...
--
-- Constraints for table `tab_cuenta_autorizados`
--
ALTER TABLE `tab_cuenta_autorizados`
...
--
-- Constraints for table `tab_cuenta_movimiento`
--
ALTER TABLE `tab_cuenta_movimiento`
...
--
-- Constraints for table `tab_solicitud_credito`
--
ALTER TABLE `tab_solicitud_credito`
