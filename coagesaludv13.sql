...
--
-- Servidor: localhost
-- Tiempo de generación: 25-04-2017 a las 23:31:32
...
(65, 27.3, 23.3, 4, 176.7),
(66, 27.3, 23.77, 3.53, 152.93),
(67, 27.3, 24.24, 3.06, 128.69),
(68, 27.3, 24.73, 2.57, 103.96),
(69, 27.3, 25.22, 2.08, 78.74),
(70, 27.3, 25.73, 1.57, 53.01),
(71, 27.3, 26.24, 1.06, 26.77),
(72, 27.31, 26.77, 0.54, 0);
...
(11, 'aporte', '2017-04-24', 500, 0, 600, '01-23432342'),
(12, 'aporte del mes de abril', '2017-04-24', 5, 0, 744, '01-4576743');
...
--
ALTER TABLE `tab_calculo`
  MODIFY `calculos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
...
--
ALTER TABLE `tab_cuenta_movimiento`
  MODIFY `cuentamovimiento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
