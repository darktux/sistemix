			...
			<table id="tabla1" data-toggle="table" class="table table-striped table-hover"  data-url="php/TipoCredito.php?acc=getjsontabla" data-click-to-select="true"  data-show-refresh="true" data-search="true" data-pagination="true" data-page-size="5" data-page-list="[5,8,10,20,50,100]">
			    <thead>
				    <tr>
				    	...
				    	<th data-field="tipocredito_correlativo" data-align="center">Correlativo</th>
...
<script type="text/javascript">
			...
			$.ajax({
	        	...
	        	success:function(responseText){
	        		if(/Registro/.test(responseText)){
	        			...
	        			alert(responseText);
	        			$("#formulario")[0].reset();
		        		$('#tabla1').bootstrapTable('refresh',{url:'php/TipoCredito.php?acc=getjsontabla'});/*CAMBIAR LA RUTA DE ACUERDO AL FORMULARIO A TRABAJAR ************/
    ...
    window.operateEvents = {
        ...
        'click .edit': function (e, value, row, index) {
            ...
            $("#cor").val(JSON.stringify(row.tipocredito_correlativo).replace(/"/gi,''));
